...
public class CommentBean {
	...
	public CommentBean() {}
	public CommentBean(int postNum, int commentNum, String id, String content, String time, float score, int voteNum, int parrentComment, int childComment) {
	...
	public int getChildeComment() {return this.childComment  ;}
}
